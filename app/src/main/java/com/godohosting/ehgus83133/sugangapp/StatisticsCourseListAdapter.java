...
public class StatisticsCourseListAdapter extends BaseAdapter {
    ...
    public StatisticsCourseListAdapter(Context context, List<Course> courseList, StatisticsFragment parent) {
    ...
    public View getView(final int i, View View, ViewGroup viewGroup) {
        ...
        courseDivide.setText(courseList.get(i).getCourseDivide() + "분반");
            if(courseList.get(i).getCoursePersonnel() == 0) {
                ...
                if(rate > 20) {
                    ...
                    courseRate.setTextColor(parent.getResources().getColor(R.color.colorPrima));
                }else if(rate <= 100){
        ...
        deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(android.view.View v) {
                    ...
                    DeleteRequest deleteRequest = new DeleteRequest(userID, courseList.get(i).getCourseID() + "", responseListner);
